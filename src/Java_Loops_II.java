...
print the series corresponding to the given a, b, and n values as a single line of n
...
public class Java_Loops_II {
    public static void main(String[] args) {
        ...
        int q = in.nextInt(); //line contains an integer, q, denoting the number of queries.
        for(int i = 0;i<=q;i++) {
            int a = in.nextInt();
            int b = in.nextInt();
            int n = in.nextInt();
